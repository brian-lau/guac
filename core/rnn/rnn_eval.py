...
def main(param=None):
    ...
    for d in datasets:
        ...
        model_acc = evaluation.calc_task_wise_acc(true_labels.loc[dev_items], predictions.loc[dev_items], 'rnn')
        model_f1s = evaluation.calc_task_wise_f1s(true_labels.loc[dev_items], predictions.loc[dev_items], 'rnn')
