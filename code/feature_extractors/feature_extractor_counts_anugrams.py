...
class FeatureExtractorCountsAnUgrams(FeatureExtractorCounts):

    def __init__(self, annotation, groups=None, test_fold=0):
        #print "Creating from arguments"
        name = 'anugrams'
        prefix = '_anu-' + annotation + '_'
        FeatureExtractorCounts.__init__(self, name, prefix, add_oov=True,
                                        ...
                                        dev_subfold=None)
        self.params['n'] = 1
        self.params['concat_oov_counts'] = False
        self.params['append_dataset'] = False
        self.params['annotation'] = annotation
        self.params['groups'] = groups
        FeatureExtractorCountsAnUgrams.extend_dirname(self)
    ...
    def extract_tokens_from_file(self, responses, input_filename, n, token_dict):
        ...
        for rid in rids:
            ...
            if dataset in self.params['groups']:
...
def main():
    ...
    extractor = FeatureExtractorCountsAnUgrams(test_fold=test_fold, dev_subfold=dev_subfold, n=n,
